...
class GPT(nn.Module):
    ...
    def forward(self, idx, targets=None):
        ...
        pos = torch.arange(0, t, dtype=torch.long, device=device) # shape (t) - position
        ...
        for block in self.transformer.h:
            x = block(x)
        x = self.transformer.ln_f(x) # x is of shape (b, t, n_embd)
...
if __name__ == "__main__":
    ...
    a = torch.randint(0, 3000, (10, 512)).to(device)
    c, loss = gpt(a)
    print(c.shape)
