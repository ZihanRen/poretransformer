...
epochs = 20 # TODO: change this to a better value
        ...
        for epoch in range(epochs):
            ...
            with tqdm(
                ...
                for i, imgs in enumerate(pbar):
                    ...
                    vq_loss = + q_loss + rec_loss + disc_factor * g_loss
            ...
            self.training_losses.append(trian_loss_per_epoch/steps_per_epoch)
